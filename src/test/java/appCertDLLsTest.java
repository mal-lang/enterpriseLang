...
public class appCertDLLsTest{
    ...
    public void test4(){
        ...
        User user = new User("user");
        User user2 = new User("user2");
        Windows windows = new Windows("windows",true,false,false,false,true,false,true,false,false,false,false,false);
    ...
    public void test5(){
        ...
        Administrator administrator = new Administrator("administrator");
        Administrator administrator2 = new Administrator("administrator2");
        Windows windows = new Windows("windows",true,false,false,false,true,false,false,false,false,false,false,false);
