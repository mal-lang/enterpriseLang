...
public class bash_profileAndBashrcTest {
  ...
  public void linuxTestWithDefense() {
    User user = new User("user");
    Linux linux= new Linux("linux",false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false);
  ...
  public void macOSTestwithDefense() {
    User user = new User("user");
    MacOS macOS= new MacOS("macOS",false,false,true,false,false,false,false,false,false,false,false,false,false,false,false,false,false);
