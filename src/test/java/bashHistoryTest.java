...
public class bashHistoryTest {
  ...
  public void linuxTestWithDefense() {
    User user = new User("user");
    Linux linux= new Linux("linux",false,false,false,true,false,false,false,false,false);//turnOfBashHistory in win is the defens
    Administrator admin = new Administrator("admin");
  ...
  public void macOSTestwithDefense() {
    User user = new User("user");
    MacOS macOS= new MacOS("macOS",false,false,false,false,true,false,false,false,false);
    Administrator admin = new Administrator("admin");
